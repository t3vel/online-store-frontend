    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.genderButtonsContainer}>
          <button className={styles.maleButton}><span class="material-symbols-outlined">
            male
          </span>
            Male
          </button>
        ...
        <div className={styles.inputsContainer}>
          <div>
            ...
            <div><input type="text" /> years ( yrs )</div>
          </div>
          <div>
            <div className={styles.inputLabel}>Height</div>
            <div><input type="text" /> centimeters ( cm )</div>
          </div>
          <div>
            <div className={styles.inputLabel}>Weight</div>
            <div><input type="text" /> kilograms ( kg )</div>
          </div>
        </div>
